...
const WeddingInvitation = () => {
  ...
  return (
    <section
      id="invitation"
      className="snap-start h-svh min-h-[-webkit-fill-available] bg-[#e1ded7] font-montserrat text-xs sm:text-base flex flex-col items-center justify-center bg-cover bg-center gap-1 text-black"
    >
