...
const RSVP = () => {
  ...
  return (
    <section
      id="rsvp"
      className="snap-start w-full h-screen bg-[#e1e1e1] flex items-center justify-center flex-col md:text-base text-xs relative"
    >
      <section
      ...
      ></section>
      <section
        className="w-[90%] h-[55%] md:h-[70%] md:w-[45%] bg-white text-center relative flex justify-center 
                   shadow-[0_10px_40px_rgba(0,0,0,0.3),0_4px_10px_rgba(0,0,0,0.2),inset_0_2px_5px_rgba(255,255,255,0.5)] 
                   rounded-3xl max-w-[550px]"
      >
        <header className="md:tracking-[1rem] font-greatVibes text-5xl md:text-6xl absolute top-[10%] mx-auto w-full">
          R.S.V.P
        </header>
        ...
        <section className="absolute top-[20%] right-[5%] text-right font-montserrat">
          ...
          <header className="font-bold text-base tracking-[0.2rem] md:text-lg md:tracking-[0.5rem]">
            MARCH 01, 2025
          </header>
        </section>
        ...
        >
          ...
          <button
            className="w-[50%] mt-4 md:mt-8 md:px-6 md:py-3 px-2 py-2 text-white md:text-lg text-xs font-semibold 
             bg-gradient-to-r from-[#d97706] to-[#b45309] 
             rounded-full shadow-[0_5px_15px_rgba(217,119,6,0.4)] 
             hover:shadow-[0_8px_20px_rgba(217,119,6,0.6)] 
